CREATE VIEW [payroll].[qry_get_other_earnings_history]
AS
SELECT     TOP (100) PERCENT [hrm].employee.employee_id, SUM(payroll.payroll_history.amount) AS OtherEarnings, payroll.payroll_history.pay_period
