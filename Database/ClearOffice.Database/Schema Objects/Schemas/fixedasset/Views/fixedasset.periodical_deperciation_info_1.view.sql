CREATE VIEW fixedasset.periodical_deperciation_info
AS
SELECT     fixedasset.depreciation.depreciation_id, fixedasset.depreciation.asset_id, fixedasset.depreciation.fiscal_year, fixedasset.depreciation.fiscal_period, 
                      ...
                      fixedasset.asset.category, fixedasset.asset_category.category_name, fixedasset.get_dateTime_reprecentation(fixedasset.depreciation.year, 
                      fixedasset.depreciation.month) AS date_calculated
