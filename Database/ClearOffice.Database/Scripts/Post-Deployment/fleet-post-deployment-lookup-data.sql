...
insert into fleet.lookup(lookup_id,lookup_name) values(13,'Vendor')
insert into fleet.lookup(lookup_id,lookup_name) values(14,'Tire Status')
insert into fleet.lookup(lookup_id,lookup_name) values(15,'Tire Size')
insert into fleet.lookup(lookup_id,lookup_name) values(16,'Tire Type')
insert into fleet.lookup(lookup_id,lookup_name) values(17,'Tire Manufacturer')
go
...
-- Tire Status
insert into fleet.lookup_item(lookup_id,item_name) values(14,'Mounted')
insert into fleet.lookup_item(lookup_id,item_name) values(14,'UnMounted')
insert into fleet.lookup_item(lookup_id,item_name) values(14,'Disposed')
insert into fleet.lookup_item(lookup_id,item_name) values(14,'Unknown')

-- Tire Sizes
insert into fleet.lookup_item(lookup_id,item_name) values(15,'Size-1')
insert into fleet.lookup_item(lookup_id,item_name) values(15,'Size-2')
insert into fleet.lookup_item(lookup_id,item_name) values(15,'Size-3')

-- Tire Types
insert into fleet.lookup_item(lookup_id,item_name) values(16,'Radial')
insert into fleet.lookup_item(lookup_id,item_name) values(16,'Solid')
insert into fleet.lookup_item(lookup_id,item_name) values(16,'Bias/Cross Ply')
insert into fleet.lookup_item(lookup_id,item_name) values(16,'Belted bias')
insert into fleet.lookup_item(lookup_id,item_name) values(16,'Semi-pneumatic')

-- Tire Manufacturer
insert into fleet.lookup_item(lookup_id,item_name) values(17,'Matador-Addis Tire')
insert into fleet.lookup_item(lookup_id,item_name) values(17,'Bridgestone')
insert into fleet.lookup_item(lookup_id,item_name) values(17,'JK')
insert into fleet.lookup_item(lookup_id,item_name) values(17,'Continental')
insert into fleet.lookup_item(lookup_id,item_name) values(17,'Michelin')
insert into fleet.lookup_item(lookup_id,item_name) values(17,'Pirelli')
insert into fleet.lookup_item(lookup_id,item_name) values(17,'Yokohama')